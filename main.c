...
void pinCreation(struct bankAccount accounts[],int numAccounts){
    ...
    scanf("%d",&key);
    if(key){
        scan : printf("Enter Account number:");
        scanf("%ld",&accountno);
    ...
    do{
        ...
        switch(choice){
            ...
            case 3:
                   ...
                   scanf("%f",&amount);
                   deposit(accounts,numAcccounts,accountNumber,amount);
                   break;
            case 4:
                   ...
                   scanf("%f",&amount);
                   withdrawal(accounts,numAcccounts,accountNumber,amount);
                   break;
            case 5: 
                   printf("Enter Account Number to check Balance : ");
                   scanf("%ld",&accountNumber);
                   check(accounts,numAcccounts,accountNumber);
                   break;
            case 6:
